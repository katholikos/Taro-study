...
var createCallbackManager = function createCallbackManager() {
  ...
  var remove = function remove(opt) {
    var pos = callbacks.findIndex(function (_ref2) {
...
var createScroller = function createScroller(inst) {
  // const dom = findDOMNode(inst)
  var el = document.querySelector('.taro-tabbar__panel') || document.body;
...
var startPullDownRefresh = temporarilyNotSupport('startPullDownRefresh'); // export const canvasToTempFilePath = temporarilyNotSupport('canvasToTempFilePath')
...
var canvasGetImageData = function canvasGetImageData(_ref) {
  var canvasId = _ref.canvasId,
      ...
      width = _ref.width,
      height = _ref.height;
  var componentInstance = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : document.body;
  var dom = Nerv.findDOMNode(componentInstance);
  /** @type {HTMLCanvasElement} */

  var canvas = dom.querySelector("[canvasId=".concat(canvasId, "]"));
...
var canvasPutImageData = function canvasPutImageData(_ref) {
  var canvasId = _ref.canvasId,
      data = _ref.data,
      x = _ref.x,
      y = _ref.y,
...
var createCanvasContext = function createCanvasContext(canvasId) {
   ...
   * @param {Boolean} reserve 本次绘制是否接着上一次绘制。
  ...
  var customProperties = {
     ...
     */
    setFillStyle: function setFillStyle(color) {
      ctx.fillStyle = color;
    },
    ...
    */
    setLineDash: function setLineDash(pattern, offset) {
    ...
    */
    setStrokeStyle: function setStrokeStyle(color) {
  ...
  var CanvasContext = new Proxy(ctx, {
    get: function get(target, p) {
      if (p === 'draw') return draw;
      var value = customProperties[p] || target[p];
