...
var createHistory = function createHistory(props) {
  ...
  Taro__default._$router = initialLocation;
  ...
  var setState = function setState(nextState) {
    ...
    Taro__default._$router = history.location;
...
function (_Component) {
  ...
  _createClass(Router, [{
    ...
    value: function render() {
      ...
      var router = this;
      var currentLocation = Taro__default._$router;
...
var mountApis = function mountApis(history) {
  Taro__default.navigateTo = createNavigateTo(history);
  Taro__default.navigateBack = createNavigateBack(history);
  Taro__default.redirectTo = createRedirectTo(history);
  Taro__default.reLaunch = createReLaunch(history);
};
